...
const STEP_REPLACEMENTS = {
	...
	"data-dir": [
		["getVettaConfigDirName", "getOriginConfigDirName"],
		["getVettaHomePath", "getOriginHomePath"],
		["VETTA_HOME_ENV", "ORIGIN_HOME_ENV"],
		["VETTA_CONFIG_DIR_ENV", "ORIGIN_CONFIG_DIR_ENV"],
		["vettaHomePath", "originHomePath"],
		["vettaHome", "originHome"],
		["DEFAULT_CONFIG_DIR_NAME = \".vetta\"", "DEFAULT_CONFIG_DIR_NAME = \".origin\""],
		["CONFIG_DIR_NAME = \".vetta\"", "CONFIG_DIR_NAME = \".origin\""],
		['CONFIG_DIRECTORY = ".vetta"', 'CONFIG_DIRECTORY = ".origin"'],
		['PROJECT_CONFIG_DIRECTORY = ".vetta"', 'PROJECT_CONFIG_DIRECTORY = ".origin"'],
		["VETTA_", "ORIGIN_"],
		["~/.vetta", "~/.origin"],
		[".vetta", ".origin"],
	],
	ipc: [
		["window.vettaQuickPanel", "window.originQuickPanel"],
		["window.vettaOnboarding", "window.originOnboarding"],
		["window.vettaRemoteDesktop", "window.originRemoteDesktop"],
		["window.vettaPet", "window.originPet"],
		["window.vetta", "window.originApp"],
		["__vettaRecordingAudio", "__originRecordingAudio"],
		["__vettaOcr", "__originOcr"],
		["__VETTA_PLUGIN_DEV_MODULES__", "__ORIGIN_PLUGIN_DEV_MODULES__"],
		["__VETTA_PLUGIN_HOST__", "__ORIGIN_PLUGIN_HOST__"],
	...
	identity: [
		...
		["cap.foundation.vetta", "cap.foundation.origin"],
		["cap.domain.vetta", "cap.domain.origin"],
