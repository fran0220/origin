...
const LIB_PREFIXES = [
	...
	"packages/runtime-evaluation/",
	"packages/runtime-recording/",
...
function checkPluginDesktopGlobal(posixPath, text, findings) {
	...
	// - security-probe: intentional audit of window.originApp bypass / trust boundary
	...
	if (usesDesktopPluginGlobal(posixPath, text)) {
		findings.push(`${posixPath}: plugins must use the public plugin SDK instead of window.originApp`);
	}
}
...
const roots = [
	...
	join(repoRoot, "packages/runtime-evolution"),
	join(repoRoot, "packages/runtime-node"),
	join(repoRoot, "packages/runtime-mcp"),
	join(repoRoot, "packages/runtime-telemetry"),
	join(repoRoot, "packages/runtime-evaluation"),
	join(repoRoot, "packages/runtime-recording"),
