...
- [Extension compatibility contracts](../../../packages/coding-agent/src/extensions/compatibility/contracts.ts)
- [Extension compatibility resolver](../../../packages/coding-agent/src/extensions/compatibility/resolver.ts)
