...
| `recording:capture` | `ctx.recording`（主进程离屏网页录制） | [conversation-and-agent](./conversation-and-agent.md#网页录制-recording) |
