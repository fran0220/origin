...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{
				find: "@origin-org/plugin-sdk/manifest",
				replacement: resolve(__dirname, "../../packages/plugins/plugin-sdk/src/manifest.ts"),
			},
			{
				find: "@origin/ai/reasoning-presets",
				replacement: resolve(__dirname, "../../packages/ai/src/reasoning-presets.ts"),
			},
			{ find: "@origin/ai/testing", replacement: resolve(__dirname, "../../packages/ai/src/testing/index.ts") },
			{ find: "@origin/ai/protocol", replacement: resolve(__dirname, "../../packages/ai/src/protocol/index.ts") },
			{ find: "@origin/ai", replacement: resolve(__dirname, "../../packages/ai/src/index.ts") },
			{ find: "@origin/agent-core", replacement: resolve(__dirname, "../../packages/agent/src/index.ts") },
			{
			...
			{ find: "@origin/coding-agent/config", replacement: resolve(__dirname, "../../packages/coding-agent/src/config.ts") },
			{
			...
			{
				find: "@origin/coding-agent/cli-guidance",
			...
			{ find: "@origin/runtime-core", replacement: resolve(__dirname, "../../packages/runtime-core/src/index.ts") },
			{ find: "@origin/runtime-checkpoints", replacement: resolve(__dirname, "../../packages/runtime-checkpoints/src/index.ts") },
			{ find: "@origin/runtime-desktop", replacement: resolve(__dirname, "../../packages/runtime-desktop/src/index.ts") },
			{ find: "@origin/runtime-mcp/auth", replacement: resolve(__dirname, "../../packages/runtime-mcp/src/auth/index.ts") },
			{
				find: "@origin/runtime-mcp/browser",
				replacement: resolve(__dirname, "../../packages/runtime-mcp/src/browser/index.ts"),
			},
			{ find: "@origin/runtime-mcp/client", replacement: resolve(__dirname, "../../packages/runtime-mcp/src/client/index.ts") },
			{ find: "@origin/runtime-mcp/config", replacement: resolve(__dirname, "../../packages/runtime-mcp/src/config/index.ts") },
			{
				find: "@origin/runtime-mcp/protocol",
				replacement: resolve(__dirname, "../../packages/runtime-mcp/src/protocol/index.ts"),
			},
			{ find: "@origin/runtime-mcp", replacement: resolve(__dirname, "../../packages/runtime-mcp/src/index.ts") },
			{
