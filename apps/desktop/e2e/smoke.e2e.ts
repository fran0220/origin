...
describe("Origin Desktop smoke — boot contract", () => {
...
describe("Origin Desktop smoke — config isolation", () => {
...
describe("Origin Desktop smoke — main-process mock probe", () => {
	it("can mock dialog.showOpenDialogSync and intercept the call", async () => {
		...
		await mockShowOpenDialog.mockReturnValue(["origin-e2e-selection"]);
