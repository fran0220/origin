...
// 而 Electron 以单文件加载 preload、无法解析同级 chunk，导致 window.originApp 整体加载失败
// （同 apis/quick-panel.ts 的坑）。
const RELOAD_GESTURE = "origin:appshot:reload-gesture";
const CAPTURED = "origin:appshot:captured";
const CAPTURE_ERROR = "origin:appshot:capture-error";
const ONBOARDING_SHOW = "origin:onboarding:show";
