...
// 共享 chunk，而 Electron 以单文件加载 preload、无法解析同级 chunk，导致 window.originApp 整体加载失败。
const RELOAD_HOTKEY = "origin:quickpanel:reload-hotkey";
const RUN_PROMPT = "origin:quickpanel:run-prompt";
