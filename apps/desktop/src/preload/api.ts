...
import type { DesktopCheckpointsApi } from "./api-types/checkpoints.js";
import type { DesktopConfigApi } from "./api-types/config.js";
import type { DesktopCloudApi, DesktopConnectionsApi } from "./api-types/connections.js";
...
import type { DesktopEvaluationApi } from "./api-types/evaluation.js";
import type { DesktopEvolutionApi } from "./api-types/evolution.js";
...
import type { DesktopRecordingApi } from "./api-types/recording.js";
...
export type * from "./api-types/checkpoints.js";
export type * from "./api-types/config.js";
export type * from "./api-types/connections.js";
export type * from "./api-types/debug.js";
export type * from "./api-types/dialog.js";
export type * from "./api-types/downloads.js";
export type * from "./api-types/evaluation.js";
export type * from "./api-types/evolution.js";
...
export type * from "./api-types/recording.js";
...
export interface DesktopApi {
	...
	connections: DesktopConnectionsApi;
	...
	evaluation: DesktopEvaluationApi;
	checkpoints: DesktopCheckpointsApi;
	downloads: DesktopDownloadsApi;
	evolution: DesktopEvolutionApi;
	im: DesktopImApi;
	debug: DesktopDebugApi;
	diagnostics: DesktopDiagnosticsApi;
	project: DesktopProjectApi;
	recording: DesktopRecordingApi;
