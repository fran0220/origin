...
import { EMPTY_AGENT_ABILITIES, pluginBlueprintId } from "@origin/agent-profile";
...
function readAvatarDataUrl(
	...
	// 内联成 data URL 而不是 origin-plugin:// 地址：系统插件、dev 链接、已安装包各有一套
