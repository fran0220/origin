import { HOSTED_ROUTE_SEGMENT_PATTERN, isValidHostedRouteSegment } from "@origin-org/capability-sdk";
import type { PluginNavBadge, PluginNavBadgeTone } from "@origin-org/plugin-sdk";
