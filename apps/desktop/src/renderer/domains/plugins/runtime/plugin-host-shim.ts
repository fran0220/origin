...
declare global {
	/**
	 * `origin-host://*` shim（`main/plugins/plugin-protocol.ts`）在插件模块求值时读这个
	 ...
	 */
	var __ORIGIN_PLUGIN_HOST__: typeof pluginHostShimModules | undefined;
	var __mf_module_cache__: ModuleFederationModuleCache | undefined;
}

export function installPluginHostShim(): void {
	globalThis.__ORIGIN_PLUGIN_HOST__ = { ...pluginHostShimModules };
