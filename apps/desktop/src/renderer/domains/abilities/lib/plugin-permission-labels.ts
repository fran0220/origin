...
export const PLUGIN_PERMISSION_LABEL_KEYS = {
	...
	"browser.runtime.manage": "permission.browserRuntimeManage",
	...
	"evaluation:write": "permission.evaluationWrite",
...
export const PLUGIN_PERMISSION_PRESENTATIONS = {
	...
	"browser.interact": {
		descriptionKey: "permission.description.browserInteract",
		group: "execution",
		risk: "high",
		visual: "external",
	},
	"browser.profile.persist": {
		descriptionKey: "permission.description.browserProfilePersist",
		group: "execution",
		risk: "high",
		visual: "external",
	},
	"browser.attach": {
		descriptionKey: "permission.description.browserAttach",
		group: "execution",
		risk: "high",
		visual: "external",
	},
	"browser.runtime.manage": {
		descriptionKey: "permission.description.browserRuntimeManage",
		group: "execution",
		risk: "high",
		visual: "execution",
	},
	...
	"evaluation:write": {
		descriptionKey: "permission.description.evaluationWrite",
		group: "intelligence",
		risk: "medium",
		visual: "intelligence",
	},
