...
export const SETTINGS_TABS: readonly SettingsTabRegistration[] = [
	...
	{ key: "pet", label: "Origin Vivi", labelKey: "tabPet", icon: "icon-[mdi--paw-outline]" },
	{
		key: "permissions",
		label: "权限管理",
...
export const SETTINGS_SECTIONS = [
	...
	{ tab: "environment", id: "environment-recording", title: "网页录制", titleKey: "section_environment-recording" },
