...
import { agentAvatarUrl } from "../../../shared/agent-profile-avatar";

export { AGENT_AVATAR_OPTIONS, agentAvatarUrl } from "../../../shared/agent-profile-avatar";
...
export function useAgentAvatarResolver(): (subject: AvatarSubject) => string {
	...
	useEffect(() => {
		...
		const blueprints = window.originApp?.agentProfiles?.listBlueprints?.();
