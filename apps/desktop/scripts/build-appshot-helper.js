...
const APP_NAME = "Origin Computer Use";
const BUNDLE_ID = "com.origin.desktop.computer-use";
...
<dict>
	...
	<string>Origin Computer Use needs to record your screen to capture the active window for the assistant.</string>
</dict>
</plist>
`;
}
