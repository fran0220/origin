...
test("uses stable release artifact names for baseline installation", () => {
	const stableArtifactPattern = /^Origin-0\.5\.46(?:-win-x64\.exe|-mac\.zip|-arm64-mac\.zip|\.AppImage)$/;
	for (const artifactName of [
		"Origin-0.5.46-win-x64.exe",
		"Origin-0.5.46-mac.zip",
		"Origin-0.5.46-arm64-mac.zip",
		"Origin-0.5.46.AppImage",
	]) {
