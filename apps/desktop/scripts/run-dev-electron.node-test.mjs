...
test("development Electron enables local action approval bypass by default", () => {
	assert.equal(resolveDevProcessEnvironment({}).ORIGIN_DEV_AUTO_APPROVE_ACTIONS, "1");
});

test("development approval bypass can be disabled explicitly", () => {
	assert.equal(
		resolveDevProcessEnvironment({ ORIGIN_DEV_AUTO_APPROVE_ACTIONS: "0" }).ORIGIN_DEV_AUTO_APPROVE_ACTIONS,
		"0",
	);
});
