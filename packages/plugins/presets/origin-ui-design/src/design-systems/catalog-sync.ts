...
export const DESIGN_CATALOG_SOURCES: readonly string[] = [
	"https://raw.githubusercontent.com/openvetta/origin-design-templates/main/.origin/design-templates.json",
	"https://cdn.jsdelivr.net/gh/openvetta/origin-design-templates@main/.origin/design-templates.json",
];
...
/** 清单在资源仓库中的固定位置。 */
const CATALOG_PATH_IN_REPO = ".origin/design-templates.json";

/**
 * 由清单地址推出仓库根地址。
 *
 * 清单里的资源地址是**相对仓库根**的（`templates/<slug>/...`），而 `new URL(rel, base)`
 * 是相对清单所在目录解析的——直接拿清单地址当 base 会多出一段 `.origin/`。
 */
