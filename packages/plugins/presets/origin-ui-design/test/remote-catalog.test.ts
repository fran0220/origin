...
const BASE = "https://cdn.example.com/gh/openvetta/origin-design-templates@main/";

function catalog(templates: unknown[]): Record<string, unknown> {
	return { schemaVersion: 1, name: "origin-design-templates", templates };
}
...
describe("parseRemoteCatalog", () => {
	...
	it("带上普通参考素材：截图、参考 HTML 都进 resources", () => {
		...
		expect(binary).toMatchObject({
			encoding: "binary",
			url: "https://cdn.example.com/gh/openvetta/origin-design-templates@main/templates/linear/screenshots/home.webp",
		});
	});
