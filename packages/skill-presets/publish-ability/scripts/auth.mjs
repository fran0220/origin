 ...
 *
 * 必须容忍两种写法：桌面端注入的 ORIGIN_SERVER_URL 自带 /api/v1，手工设
 * ORIGIN_API_BASE_URL 的人通常只写到域名。不统一就会拼出 /api/v1/api/v1/... 而 404。
 */
 ...
 * 读取登录态。
 *
 * `~/.origin/auth.json` 是客户端为外部进程下沉的凭据契约，登录、刷新、登出都会同步
