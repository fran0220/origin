...
import { validateArticle } from "../origin-blog/scripts/validate-blog.mjs";
...
describe("origin-blog validator", () => {
...
async function makeDirectory(): Promise<string> {
	const directory = await mkdtemp(join(tmpdir(), "origin-blog-test-"));
