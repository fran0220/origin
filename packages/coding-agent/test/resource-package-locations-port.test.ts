...
describe("resource package location ports", () => {
	it("uses injected path semantics and stable digest without ambient Node state", () => {
		...
		expect(locations.baseDir("project")).toBe("/workspace/project/.origin");
		...
		expect(locations.identity("./tools", "project")).toBe("local:/workspace/project/.origin/tools");
